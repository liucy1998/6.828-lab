	     ...
	     envid_t dstenvid, void *dstva, int perm)
{
	...
	if(err)
		return err;
	// Check if srcva is mapped
	pte_t *src_va_pte;
	struct PageInfo *src_va_pp = page_lookup(src_e->env_pgdir, srcva, &src_va_pte);
	if(src_va_pte == NULL)
		return -E_INVAL;
	...
	return page_insert(dst_e->env_pgdir, src_va_pp, dstva, perm);
}
